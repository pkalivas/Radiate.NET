...
using Radiate.NET.Optimizers.Evolution.Engine.ParentalCriteria;
using Radiate.NET.Optimizers.Evolution.Engine.SurvivorCriteria;

namespace Radiate.NET.Optimizers.Evolution
{
